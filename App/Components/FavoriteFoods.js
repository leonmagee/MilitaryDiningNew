  ...
  render() {
    ...
    if (!justOneFavorite) {
      favFoodList = (
        <View style={styles.noFavWrap}>
          <Text style={styles.noFavText}>You have no favorites saved.</Text>
        </View>
      );
    }
    ...
    return (
      <View style={defaults.defaultMainWrap}>
        ...
        <ScrollView style={styles.scrollWrap}>{favFoodList}</ScrollView>
...
mapStateToProps = state => ({
  restData: state.restMenuItemData,
